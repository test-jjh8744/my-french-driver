...
var doc, ssrDocument, win, ssrWindow;
...
function addClass(className) {
  ...
  for (let i = 0; i < classes2.length; i += 1) {
    for (let j = 0; j < this.length; j += 1) {
      if (typeof this[j] !== "undefined" && typeof this[j].classList !== "undefined") this[j].classList.add(classes2[i]);
    }
  }
  return this;
}
function removeClass(className) {
  ...
  for (let i = 0; i < classes2.length; i += 1) {
    for (let j = 0; j < this.length; j += 1) {
      if (typeof this[j] !== "undefined" && typeof this[j].classList !== "undefined") this[j].classList.remove(classes2[i]);
    }
  }
  return this;
}
...
function toggleClass(className) {
  ...
  for (let i = 0; i < classes2.length; i += 1) {
    for (let j = 0; j < this.length; j += 1) {
      if (typeof this[j] !== "undefined" && typeof this[j].classList !== "undefined") this[j].classList.toggle(classes2[i]);
    }
  }
  return this;
}
...
function children(selector) {
  ...
  for (let i = 0; i < this.length; i += 1) {
    ...
    for (let j = 0; j < childNodes.length; j += 1) {
      if (!selector) {
        if (childNodes[j].nodeType === 1) children2.push(childNodes[j]);
...
var swiper_esm_bundle_exports = {};
__export(swiper_esm_bundle_exports, {
  default: () => swiper_esm_bundle_default
});
function updateSize() {
  const swiper = this;
  let width;
  ...
  if (swiper.params.slidesPerView !== "auto" && swiper.params.slidesPerView > 1) {
    if (swiper.params.centeredSlides) {
      ...
      for (i = 0; i < Math.ceil(swiper.params.slidesPerView); i += 1) {
        ...
        if (index2 > swiper.slides.length) break;
...
function updateClickedSlide(e) {
  ...
  if (slide2) {
    for (let i = 0; i < swiper.slides.length; i += 1) {
      if (swiper.slides[i] === slide2) slideFound = true;
    }
  }
...
function loopCreate() {
  ...
  slides.each((index2, el) => {
    const slide2 = $(el);
    if (index2 < swiper.loopedSlides) appendSlides.push(el);
    if (index2 < slides.length && index2 >= slides.length - swiper.loopedSlides) prependSlides.push(el);
...
function onTouchStart(event) {
  ...
  if (e.type !== "touchstart") {
    ...
    if ($targetEl.is(data2.formElements)) preventDefault = false;
...
var Methods, Utils, Support, SwiperClass, update, translate, transition2, slide, loop, grabCursor, manipulation, Device, dummyEventAttached, events, breakpoints, classes, images, checkOverflow$1, defaults, prototypes, extendedDefaults, Swiper, Device$1, Support$1, Browser, Browser$1, Resize, Observer, Observer$1, Virtual, Virtual$1, Keyboard, Keyboard$1, Mousewheel, Mousewheel$1, Navigation, Navigation$1, Pagination, Pagination$1, Scrollbar, Scrollbar$1, Parallax, Parallax$1, Zoom, Zoom$1, Lazy, Lazy$1, Controller, Controller$1, a11y, A11y, History, History$1, HashNavigation, HashNavigation$1, Autoplay, Autoplay$1, Fade, EffectFade, Cube, EffectCube, Flip, EffectFlip, Coverflow, EffectCoverflow, Thumbs, Thumbs$1, components, swiper_esm_bundle_default;
var init_swiper_esm_bundle = __esm({
  "node_modules/swiper/js/swiper.esm.bundle.js"() {
    init_dom7_modular();
    init_ssr_window_esm();
    Methods = {
    ...
    extendedDefaults = {};
    Swiper = class _Swiper extends SwiperClass {
      constructor(...args) {
        let el;
        let params;
    ...
    swiper_esm_bundle_default = Swiper;
  }
});
...
var require_utils = __commonJS({
  "node_modules/react-id-swiper/lib/utils.js"(exports) {
    ...
    exports.validateChildren = function(children2) {
      var isValid = true;
      if (Array.isArray(children2)) {
        react_1.Children.forEach(children2, function(child) {
          if (!react_1.isValidElement(child)) {
            isValid = false;
          }
        });
      } else {
        isValid = react_1.isValidElement(children2);
      }
      return isValid;
    };
...
var require_ReactIdSwiper = __commonJS({
  "node_modules/react-id-swiper/lib/ReactIdSwiper.js"(exports) {
    ...
    var swiper_1 = __importDefault((init_swiper_esm_bundle(), __toCommonJS(swiper_esm_bundle_exports)));
    ...
    var ReactIdSwiper = react_1.forwardRef(function(props, externalRef) {
      ...
      }, [activeSlideKey, children2, loop2]);
      ...
      react_1.useEffect(function() {
        ...
        if (swiperInstanceRef.current !== null) {
          ...
          if (numSlides <= swiperInstanceRef.current.activeIndex) {
            var index2 = Math.max(numSlides - 1, 0);
            swiperInstanceRef.current.slideTo(index2);
          }
      ...
      if (!children2 || !ContainerEl || !WrapperEl) {
        return null;
      }
      if (!utils_1.validateChildren(children2)) {
        if (true) {
      ...
      return react_1.default.createElement(
        ContainerEl,
        { className: containerClass, dir: rtl && "rtl", ref },
        parallax && parallaxEl && renderParallax && renderParallax(props),
        react_1.default.createElement(WrapperEl, { className: wrapperClass }, react_1.Children.map(children2, renderContent)),
